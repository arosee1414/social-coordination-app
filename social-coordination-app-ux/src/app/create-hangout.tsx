    ...
    return (
        <SafeAreaView style={shared.screenContainer}>
            ...
            <View style={shared.stackHeader}>
                ...
                <Text style={[s.headerTitle, { color: colors.text }]}>Create Hangout</Text>
                <View style={{ width: 40 }} />
            </View>
                ...
                <View style={{ gap: 24 }}>
                    ...
                    <View style={shared.infoCard}>
                        ...
                        <Text style={[s.infoText, { color: colors.textSecondary }]}>
                            Hangouts are one-time plans with friends. Set the details and invite people or groups.
                        </Text>
                    </View>
                    ...
                    <View>
                        ...
                        <TouchableOpacity style={[s.pickerBtn, { borderColor: colors.cardBorderHeavy, backgroundColor: colors.inputBackground }]}>
                            <Ionicons name='calendar-outline' size={20} color={colors.subtitle} />
                            <Text style={[s.pickerText, { color: colors.subtitle }]}>Select date and time</Text>
                        </TouchableOpacity>
                    </View>

                    {/* Location */}
                    <View>
                        <Text style={shared.formLabel}>Location (optional)</Text>
                        <TextInput
                            style={[shared.formInput, { color: colors.inputText }]}
                    ...
                    <View>
                        ...
                        <TextInput
                            style={[shared.formInput, { color: colors.inputText, height: 100, textAlignVertical: 'top', paddingTop: 14 }]}
            ...
            <View style={shared.bottomCTA}>
                <TouchableOpacity
                    style={[shared.primaryBtnLarge, !title && { opacity: 0.5 }]}
                    onPress={() => router.push('/invite-selection')}
                    disabled={!title}
                >
                    <Text style={shared.primaryBtnLargeText}>Continue to Invite</Text>
                </TouchableOpacity>
            </View>
        </SafeAreaView>
    );
