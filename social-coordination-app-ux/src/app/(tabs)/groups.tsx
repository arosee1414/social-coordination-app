        ...
        <SafeAreaView style={shared.screenContainer}>
            <View style={shared.screenHeaderBordered}>
                <View style={s.headerRow}>
                    ...
                    <TouchableOpacity style={shared.fab} onPress={() => router.push('/create-group')}>
                        <Ionicons name='add' size={20} color='#fff' />
                    </TouchableOpacity>
                </View>
                <Text style={shared.screenSubtitle}>Your saved friend lists</Text>
            </View>
            ...
            <ScrollView style={{ flex: 1 }}>
                {mockGroups.length > 0 ? (
                    <View style={{ paddingHorizontal: 24, paddingVertical: 24, gap: 12 }}>
                        {mockGroups.map((group) => {
                            ...
                            return (
                                <TouchableOpacity
                                    key={group.id}
                                    style={[s.groupCard, { backgroundColor: bg.from }]}
                                    ...
                                    <View style={s.groupRow}>
                                        ...
                                        <View style={{ flex: 1 }}>
                                            ...
                                            <View style={s.memberRow}>
                                                ...
                                                <Text style={[s.memberText, { color: colors.textSecondary }]}>
                    ...
                    <View style={s.emptyState}>
                        ...
                        <TouchableOpacity style={shared.primaryBtnLarge} onPress={() => router.push('/create-group')}>
